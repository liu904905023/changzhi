...
var structureItem = '<div class="structure-item form-item" style="display:none;"><div class="hr"></div><div class="invest-line"><span class="invest-key">股东身份：</span><select class="form-control type-input" name="equityStructures[0].shareholderType" data-small="type-err" data-emperr="请选择股东身份！"><option value="" disabled selected>请选择股东身份</option><option value="1">教师</option><option value="0">学生</option><option value="2">其他</option></select><small class="help-block type-err hidden">请选择股东身份！</small></div><div class="invest-line"><span class="invest-key">股东：</span><input type="text" maxlength="64" class="form-control name-input" name="equityStructures[0].shareholder" data-small="name-err" data-emperr="股东姓名不能为空！" placeholder="请填写人名或机构名"><small class="help-block ml5 name-err hidden" >股东姓名不能为空！</small></div><div class="invest-line money-line"><span class="invest-key">持股比例：</span><input type="text" class="form-control percent-input" maxlength="6" name="equityStructures[0].shareholderRatio" data-small="percent-err" data-emperr="持股比例不能为空！" data-patenterr="0-100，保留小数点后两位。"  data-patent="^((\\d{1,2})|(\\d{1,2}\\.\\d{0,2})|(100|100\\.0|100\\.00))$" data-patent="^(\\d{1,2}\\.\\d{2})$|(100.00)$" data-trim="^\\d{1,}(\\.(\\d{1,})?)?$" placeholder="小数点后两位"><small class="help-block ml5 percent-err hidden" >持股比例不能为空！</small><span class="percent">%</span></div><span class="del oprate">删除</span></div>';


var investItem = '<div class="invest-item form-item" style="display:none;"><div class="hr"></div><div class="invest-line"><span class="invest-key">投资机构名称：</span><input type="text" maxlength="64" class="form-control  investname-input" name="invests[' + index2 + '].orgName" data-small="investname-err" data-emperr="投资机构名称不能为空！" placeholder="请填写"><small class="help-block ml5 investname-err hidden" >投资机构名称不能为空</small> </div><div class="invest-line"><span class="invest-key">融资阶段：</span><select class="form-control investstage-input" name="invests[' + index2 + '].investStageCode" data-small="investstage-err" data-emperr="请选择项目处的融资阶段！" ><option value="">请选择项目处的融资阶段</option><option value="0">种子轮</option><option value="1">天使轮</option><option value="2">A轮</option><option value="3">B轮</option><option value="4">C轮</option><option value="5">D轮</option><option value="6">E轮及以后</option></select><small class="help-block ml5 investstage-err hidden" >请选择项目处的融资阶段！</small></div><div class="invest-line money-line"><span class="invest-key">投资金额：</span><input type="text" class="form-control  investmoney-input" name="invests[' + index2 + '].investMoney" maxlength="10" data-small="investmoney-err" data-emperr="投资金额不能为空！" data-patenterr="请填写数字，最多保留小数点后两位。" data-patent="^((\\d+)|(\\d+\\.\\d{0,2}))$" data-trim="^\\d+(\\.(\\d+)?)?$" placeholder="请填写"><span class="addon">万元</span><small class="help-block ml5 investmoney-err hidden" >投资金额不能为空！</small></div><div class="invest-line"><span class="invest-key">获得时间：</span><input type="text" class="form-control  investtime-input" name="invests[' + index2 + '].gainDate" placeholder="请填写" readonly data-small="investtime-err" data-emperr="获得时间不能为空！"><small class="help-block ml5 investtime-err hidden" >获得时间不能为空！</small></div><span class="del oprate">删除</span></div>';
